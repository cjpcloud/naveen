 ...
 *
 * The ISOAdapterExceptionHandler class provides methods to handle various gRPC status runtime exceptions.
 * Each method is responsible for handling a specific error code and logging the handling information.
 */
@Slf4j
@Component
@RequiredArgsConstructor
public class ISOAdapterExceptionHandler {
     ...
     */
    public ISOAdapterExceptionHandler() {
