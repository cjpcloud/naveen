...
public class ChannelExecutorService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ChannelExecutorService.class);
    ...
    public void shutdown() {
        logger.info("Shutting down ChannelExecutorService...");
        ...
        try {
            ...
            if (!executorService.awaitTermination(60, TimeUnit.SECONDS)) {
                ...
                if (!executorService.awaitTermination(60, TimeUnit.SECONDS)) {
                    logger.error("ChannelExecutorService did not terminate");
                }
            }
